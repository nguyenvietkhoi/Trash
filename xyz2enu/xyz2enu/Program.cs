        ...
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                for (int j = 0; j < T_list.Count; j++)
                {
                    ...
                    File.AppendAllText(outputfile2, T_list[j].ToString($"F4", CultureInfo.InvariantCulture).PadLeft(9) + enu.E.ToString($"F4", CultureInfo.InvariantCulture).PadLeft(8) + enu.N.ToString($"F4", CultureInfo.InvariantCulture).PadLeft(8) + enu.U.ToString($"F4", CultureInfo.InvariantCulture).PadLeft(8) + Environment.NewLine);
                }
